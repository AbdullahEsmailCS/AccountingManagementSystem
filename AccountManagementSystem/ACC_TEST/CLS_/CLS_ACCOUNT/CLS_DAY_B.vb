...
Public Class CLS_DAY_B
    Public Function number_day_bill(ByVal guid_bill) As DataTable
        Dim CON As New CLS_CON
        Dim DT As New DataTable
        DT.Clear()
        DT = CON.SELECT_TXT("SELECT NUMBER_D,GUID FROM DAY_B where TYPE='" & guid_bill & "'")
        Return DT
    End Function
    Public Function MAX_1() As DataTable
        ...
        Dim DT As New DataTable
        DT.Clear()
        DT = CON.SELECT_TXT("SELECT ISNULL(MAX(NUMBER_D)+1,1) FROM DAY_B ")
        Return DT
    End Function
    Public Function MAX_1_T(ByVal TYPEEE As String) As DataTable
        ...
        Dim DT As New DataTable
        DT.Clear()
        DT = CON.SELECT_TXT("SELECT ISNULL(MAX(NUMBER_D),1) FROM DAY_B WHERE TYPE='" & TYPEEE & "'")
        Return DT
    End Function
    Public Function MAX_() As DataTable
        ...
        Dim DT As New DataTable
        DT.Clear()
        DT = CON.SELECT_TXT("SELECT ISNULL(MAX(NUMBER_D),1) FROM DAY_B")
        Return DT
    End Function
    ...
    Public Function MIN_() As DataTable
        ...
        Dim DT As New DataTable
        DT.Clear()
        DT = CON.SELECT_TXT("SELECT ISNULL(MIN(NUMBER_D),1) FROM DAY_B")
        Return DT
    End Function
    Public Function MIN_T(ByVal TYPEEE As String) As DataTable
        ...
        Dim DT As New DataTable
        DT.Clear()
        DT = CON.SELECT_TXT("SELECT ISNULL(MIN(NUMBER_D),1) FROM DAY_B WHERE TYPE='" & TYPEEE & "'")
        Return DT
    End Function
    Public Function guid__(ByVal id As Integer) As DataTable
        ...
        Dim DT As New DataTable
        DT.Clear()
        DT = CON.SELECT_TXT("SELECT guid FROM DAY_B where NUMBER_D=" & id & "")
        Return DT
    End Function
    Public Function show_day1(ByVal id As Integer) As DataTable
        ...
        Dim DT As New DataTable
        DT.Clear()
        DT = CON.SELECT_TXT("SELECT     dbo.DAY_B.GUID, dbo.DAY_B.NUMBER_D, dbo.DAY_B.DATE, dbo.DAY_B.NOTE, dbo.DAY_B.TYPE, dbo.DAY_B.note_day, dbo.DAY_B.GUID_JOB, dbo.JOB.NAME, dbo.DAY_B.GUID_CURRENCY,                    dbo.CURRENCY.NAME AS Expr1, dbo.DAY_B.CURRENCY_VAL  FROM         dbo.DAY_B INNER JOIN             dbo.JOB ON dbo.DAY_B.GUID_JOB = dbo.JOB.GUID INNER JOIN          dbo.CURRENCY ON dbo.DAY_B.GUID_CURRENCY = dbo.CURRENCY.GUID  where DAY_B.NUMBER_D=" & id & "")
        Return DT
    End Function
    ...
    Public Function rep_all_day(ByVal d1 As Date, ByVal d2 As Date, ByVal guid_JOB As String) As DataTable
        ...
        Return Ds
    End Function
    Public Function rep_SEARSH_ACCOUNT(ByVal guid_JOB As String, ByVal d1 As Date, ByVal d2 As Date, ByVal GUID_ACCOUNT As String) As DataTable
        Dim Ds As New DataTable
        Ds.Clear()
        Dim DAL As New DataAccessLayer
        ...
        Return Ds
    End Function
    Public Function rep_BEFORE_ACCOUNT(ByVal guid_JOB As String, ByVal d1 As Date, ByVal GUID_ACCOUNT As String) As DataTable
        Dim Ds As New DataTable
        Ds.Clear()
        Dim DAL As New DataAccessLayer
