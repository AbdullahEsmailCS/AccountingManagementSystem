...
Public Class Crystal_account
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ACC_TEST.Crystal_account.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystal_account
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystal_account = New Crystal_account()
        rpt.Site = Me.Site
        Return rpt
    End Function
