...
Public Class Crystal_ITEME
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ACC_TEST.Crystal_ITEME.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystal_ITEME
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystal_ITEME = New Crystal_ITEME()
        rpt.Site = Me.Site
        Return rpt
    End Function
