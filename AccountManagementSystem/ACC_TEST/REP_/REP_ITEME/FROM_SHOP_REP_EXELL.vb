Public Class FROM_SHOP_REP_EXELL
        ...
        Try
            ...
            For I As Integer = 0 To DGV.Rows.Count - 1
                If DGV.Rows(I).Cells(0).Value <> Nothing Then
                    dt.Rows.Add(DGV.Rows(I).Cells(1).Value, DGV.Rows(I).Cells(0).Value, DGV.Rows(I).Cells(3).Value, Me.Text, DGV.Rows(I).Cells(8).Value, DGV.Rows(I).Cells(9).Value, DGV.Rows(I).Cells(10).Value, DGV.Rows(I).Cells(11).Value, DGV.Rows(I).Cells(12).Value, DGV.Rows(I).Cells(13).Value, DGV.Rows(I).Cells(14).Value)
                End If
