Public Class FRM_branch
    ...
    Dim CLS_branch_ As New CLS_branch
    ...
    End Sub
    Sub ADD_()
        CLS_branch_.ADD_(TXT_NAME.Text, guid_user_log, "00000000-0000-0000-0000-000000000000")
    End Sub
    Sub UPDATE_()
        CLS_branch_.UPDATE_(TXT_NAME.Text, TXT_GUID.Text, guid_user_log, "00000000-0000-0000-0000-000000000000")
    End Sub
