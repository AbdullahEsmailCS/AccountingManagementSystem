Public Class FRM_GOB
    ...
    End Sub
    Sub ADD_()
        CLS_JOB_.ADD_(TXT_NAME.Text, guid_user_log, "00000000-0000-0000-0000-000000000000")
    End Sub
    Sub UPDATE_()
        CLS_JOB_.UPDATE_(TXT_NAME.Text, TXT_GUID.Text, guid_user_log, "00000000-0000-0000-0000-000000000000")
    End Sub
