Public Class FRM_STORE
    ...
    End Sub
    Sub ADD_()
        CLS_STORE_.ADD_(TXT_NAME.Text, guid_user_log, "00000000-0000-0000-0000-000000000000")
    End Sub
    Sub UPDATE_()
        CLS_STORE_.UPDATE_(TXT_NAME.Text, TXT_GUID.Text, guid_user_log, "00000000-0000-0000-0000-000000000000")
    End Sub
